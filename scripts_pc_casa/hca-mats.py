...
parser.add_argument('--dffile',help='insert the file to be analyzed',type=str,default='/home/aamad/codice/slides/work_slides/data/venezia_barriers_210715_000000.csv')
...
#%% INPUT
working_dir ='/home/aamad/codice/slides/work_slides/data'
...
if args.avg_opt==True:
  if not os.path.exists('/home/aamad/codice/slides/work_slides/output/averaged'):
    os.mkdir('/home/aamad/codice/slides/work_slides/output/averaged')
  saving_dir ='/home/aamad/codice/slides/work_slides/output/averaged'
else:
  if not os.path.exists('/home/aamad/codice/slides/work_slides/output/daily'):
    os.mkdir('/home/aamad/codice/slides/work_slides/output/daily')
  saving_dir ='/home/aamad/codice/slides/work_slides/output/daily'
